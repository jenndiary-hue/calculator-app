...
if pal < 1.35: 
    pal_desc = "Καθιστική ζωή (Καθόλου άσκηση, δουλειά γραφείου)"
elif pal < 1.55: 
    pal_desc = "Ελαφρά δραστήριος (Ελαφριά γυμναστική 1-3 φορές/εβδομάδα)"
elif pal < 1.70: 
    pal_desc = "Μέτρια δραστήριος (Μέτρια γυμναστική 3-5 φορές/εβδομάδα)"
elif pal < 1.90: 
    pal_desc = "Πολύ δραστήριος (Σκληρή προπόνηση 6-7 φορές/εβδομάδα)"
else: 
    pal_desc = "Υπερβολικά δραστήριος (Διπλές προπονήσεις ή βαριά χειρωνακτική εργασία)"
